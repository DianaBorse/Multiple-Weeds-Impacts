...
library(readr)
Biomass <- read_csv("Shadehouse/Biomass Data Sheet Experiment 2 clean.csv")
...
colnames(Biomass)[4:4] <- c("Group") ## Renaming the columns
colnames(Biomass)[9:9] <- c("Mass") ## Renaming the columns
