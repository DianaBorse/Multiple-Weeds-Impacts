...
colnames(PlotData_Combined)[4:22] <- c("Housing","PopnHist", "PopnCurr", "DwellingsCurr",
                                       "Canopy", "Height", "DBH",
...
Env_Species.pca <- prcomp(PlotData_Combined[,c("RichnessResidentNatives", "RichnessResidentWeeds", "Height", "DBH", 
                                               ...
                                               "Bare", "Disturbance",
                                                "Housing","PopnHist", "PopnCurr", "DwellingsCurr", "WN", 
...
model.full <- lm(Richness ~ RichnessResidentNatives + RichnessResidentWeeds + Height + DBH + Slope + Canopy + Vascular + Disturbance + WN +
              Housing + PopnHist + PopnCurr + DwellingsCurr + Place, data = df_Env_Species.pca)
...
# look at how they correlate
data <- df_Env_Species.pca[ , c("Height", "DBH", "Slope", "Canopy", "Vascular", "WN",
...
library(MASS) ## do to the GLM
RichnessGLM <- glm.nb(Richness ~ Housing + PopnHist +
...
MyVar <- c("Housing", "Vascular", "PopnHist", "RichnessResidentNatives")
...
# Fit a model 
M1 <- glm(Richness ~  Housing + PopnHist +
            Vascular + RichnessResidentNatives,
